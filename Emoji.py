...
\033[1;36m\033[1;36m[Programmed By @KgzNet]
\033[1;32m\033[1;32m[WhatsApp : +996********
\033[1;91m\033[1;91m[Telegram : @KgzNet
\033[33m\033[1;33m[github] :RasulHacker
...
def ige():
    os.system("clear")
    input(yellow+"\n ➡️➡️"+white+" Open Telegram 	 ")
    print(yellow+" ➡️➡️"+white+" Report Bugs...")
    os.system("xdg-open https://T.me/KgzNet")
    time.sleep(7)
    input("\n [BACK]")
    main()
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[Rasul] ')
    print(yellow+''+cyan+'[ Github ]    '+purple+' :[https://github.com/RasulHacker777] ')
    print(cyan+'║Telegram] '+purple+' :[https://t.me/kgzNet')
    print(cyan+'║[Email]     '+purple+' :[RasulHacker7777@gmail.com]\n')
    print('\n[01]Developer @kgzNet')
    print('[02] Exit')
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("#  @KgzNet Tomonidan shfrlandi \n# Whatsapp +966********** \n# Github- https://github.com/Rasulhacker777\n\n"+filedata)
    os.remove(".temp")
...
def encryptem():
    in_file= input(yellow+"\n➡️➡️"+white+" Input File  > "+cyan )
    if not os.path.isfile(in_file):
            print(error+' File not found')
            os.system("sleep 2")
            encryptem()
    out_file= input(yellow+"➡️➡️ "+white+"Output File  > " + green)
...
def main():
    os.system("clear")
    slowprint(logo)
    print(yellow+''+white+' Developer @KgzNet'+yellow+' ')
    print(yellow+'')
   ...
   # print(yellow+'║'+green+' ['+white+'7'+green+']'+yellow+' About')
    ...
    print(yellow+'')
    print(yellow+'')
    choose = input(yellow+''+red+'➡️ '+ cyan)
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view https://T.me/KgzNet')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()
   #         else:
    #   os.system('xdg-open https://T.me/KgzNet')
